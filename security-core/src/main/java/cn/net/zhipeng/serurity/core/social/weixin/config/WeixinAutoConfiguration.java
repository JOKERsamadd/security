package cn.net.zhipeng.serurity.core.social.weixin.config;

import cn.net.zhipeng.serurity.core.properties.SecurityProperties;
import cn.net.zhipeng.serurity.core.properties.WeixinProperties;
import cn.net.zhipeng.serurity.core.social.MyConnectView;
import cn.net.zhipeng.serurity.core.social.weixin.connect.WeixinConnectionFactory;
 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "zhipeng.security.social.weixin", name = "app-id")
